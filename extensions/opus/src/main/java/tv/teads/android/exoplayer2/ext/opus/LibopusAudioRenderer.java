 ...
 */
package tv.teads.android.exoplayer2.ext.opus;

import android.os.Handler;
import tv.teads.android.exoplayer2.Format;
import tv.teads.android.exoplayer2.audio.AudioProcessor;
import tv.teads.android.exoplayer2.audio.AudioRendererEventListener;
import tv.teads.android.exoplayer2.audio.SimpleDecoderAudioRenderer;
...
public final class LibopusAudioRenderer extends SimpleDecoderAudioRenderer {
  ...
  protected int supportsFormatInternal(Format format) {
    return OpusLibrary.isAvailable() && MimeTypes.AUDIO_OPUS.equalsIgnoreCase(format.sampleMimeType)
        ? RendererCapabilities.FORMAT_HANDLED : RendererCapabilities.FORMAT_UNSUPPORTED_TYPE;
  }
