...
import tv.teads.android.exoplayer2.drm.OfflineLicenseHelper;
...
import tv.teads.android.exoplayer2.source.dash.DashUtil;
...
public final class DashWidevineOfflineTest extends ActivityInstrumentationTestCase2<HostActivity> {
  ...
  private void downloadLicense() throws InterruptedException, DrmSession.DrmSessionException, IOException {
