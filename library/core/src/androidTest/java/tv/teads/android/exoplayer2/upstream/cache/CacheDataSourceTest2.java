...
import tv.teads.android.exoplayer2.testutil.FakeDataSource;
...
import tv.teads.android.exoplayer2.upstream.crypto.AesCipherDataSink;
import tv.teads.android.exoplayer2.upstream.crypto.AesCipherDataSource;
...
public class CacheDataSourceTest2 extends AndroidTestCase {
  ...
  private static CacheDataSource buildCacheDataSource(Context context, DataSource upstreamSource,
      boolean useAesEncryption) throws Cache.CacheException {
  ...
  private static void emptyCache(Cache cache) throws Cache.CacheException {
