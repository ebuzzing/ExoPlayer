...
public final class FormatTest extends TestCase {
  ...
  public void testParcelable() {
    DrmInitData.SchemeData DRM_DATA_1 = new DrmInitData.SchemeData(WIDEVINE_UUID, MimeTypes.VIDEO_MP4,
        TestUtil.buildTestData(128, 1 /* data seed */));
    DrmInitData.SchemeData DRM_DATA_2 = new DrmInitData.SchemeData(C.UUID_NIL, MimeTypes.VIDEO_WEBM,
        TestUtil.buildTestData(128, 1 /* data seed */));
